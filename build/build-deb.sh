#!/bin/sh
#
# build-deb.sh Builds the silk-web-toolkit deb binary package.
...
then
    ...
    mkdir -p ../target/deb/usr/lib/silk-web-toolkit

    cp ../target/*standalone* ../target/deb/usr/lib/silk-web-toolkit/silk.jar
    cp -r etc/silk ../target/deb/usr/bin
